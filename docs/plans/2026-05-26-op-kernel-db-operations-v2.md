...
**已知 11 人**(2026-05-26 push 系統測試訊息後陸續增量更新):
...
| `U<...>151e9f3b3dd8` | **Annie✈️安妮帶你飛✈️團體部** | push 測試後回「收到」+ 業務(張家界 BR機位) |
| `U<...>7730eec47e1d` | **可馨** | push 測試後回「收到」+ 業務(韓國釜山,@蔡妙齡) |

**未知 2 人**:群裡共 13 人,11 個已 resolve,**2 個還沒在 audit log 發過言 → user_id 未知**。
